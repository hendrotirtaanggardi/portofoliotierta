  ...
  data() {
    return {
      ...
      items: [
        {
          id: 1,
          name: 'Detection Temperature Water',
          imageUrl: 'berani',
          status: 'Detection Water is water that checks temperature levels and salt levels using a water detection tool connected to a website to store data that has been detected by the pool.',
        ...
        {
          id: 2,
          name: 'Elladine Official Shop',
          imageUrl: 'elladine',
          status: 'The e-commerce application offers a variety of products, including hijabs and related accessories.',
          tech: 'PHP, CSS',
          github: 'null',
          demo: 'http://elladineofficial.shop/?i=2'
        },
        {
          id: 3,
          name: 'Project Based Internship - Rakamin x Core Initiative',
          imageUrl: 'ecom',
          status: 'Develop and enhance web applications. Manage CI/CD tools, with a focus on Docker, to ensure seamless integration and automated deployment. Maintained code base reliability by writing unit tests using Jest. Honing my skills in Git, HTML5, Vue.js, Docker, JavaScript, Jest, and CI/CD.',
          tech: 'HTML5, Vue.Js',
          github: 'https://github.com/hendrotirtaanggardi/ecommerce-catalog.git',
          demo: 'null'
        },
        {
          id: 4,
          name: 'Project Based Internship - Rakamin x BTPN Syariah',
          imageUrl: 'main',
          status: 'Create an API from the GoLang language. Create API for uploading and deleting images. The API formed are POST, GET, PUT, and DELETE. Using several tools such as Gin Gonic Framework, Gorm, JWT Go, and Go Validator. And using the PostgreSQL database.',
          tech: 'GoLang, PostgreSQL',
          github: 'https://github.com/hendrotirtaanggardi/task-5-pbi-fullstack-developer--HENDRO-TIRTA-ANGGARDI-.git',
          demo: 'null'
        },
      ]
    };
    ...
    <article data-page="about">
      <header>
        <div
          ...
          <h4 class="text-base font-normal text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-amber-100">
              ...
              <div
                ...
                <div class="flex h-12 w-12 items-center justify-center p-0 h-full w-full lg:p-0 zoom-in">
                  <img alt="HTML" loading="lazy" decoding="async" data-nimg="1" class="drop-shadow-xl rounded rounded-xl"
                    :src="'/img/portfolio-' + item.imageUrl + '.jpeg'">
                </div>
                <div class="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div class="w-full text-left text-[10px] text-[#c1c1c1] md:text-xs lg:text-sm">
                    {{ item.status }}</div>
                  <div class="w-full mt-4 text-normal text-sm text-left text-amber-100">
                    {{ item.tech }}
                  </div>
