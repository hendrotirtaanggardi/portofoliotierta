    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 3,
          name: 'PHP',
          imageUrl: 'https://icon-icons.com/icons2/2108/PNG/512/php_icon_130857.png',
          status: 'Intermediate'
        },
        {
          id: 4,
...
<template>
    ...
    <article data-page="about">
      ...
      <header>
        <div class="text-2xl font-bold text-white mb-5 fadein-bot title-section flex items-center">
          About Me &nbsp;
          <div class="h-[1px] w-32 bg-amber-100 md:w-96 aos-init aos-animate" data-aos="zoom-in-left"
      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Hendro Tirta Anggardi. I'm a Front End Developer from Depok, West Java. 
            I am currently studying informatics engineering at Pamulang University. 
            I have 7 months of experience in software engineer.
            I enjoy creating programs. It is not just a job, but also a hobby that I am passionate about and find aesthetically valuable.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; I will build your website to be functional, user-friendly, and attractive. 
            Additionally, I will provide a personal touch to your product and ensure that the website is attention-grabbing and easy to use.
            My goal is to convey your message and identity in the most creative way possible. If you are interested in hiring me, please contact the listed contact.
          </p>
        </div>
  ...
  <div class="px-5 py-5 md:px-12 md:py-10 text-left text-amber-50 mx-3">
    <article data-page="about">
      <header>
        <div class="text-2xl font-bold text-white mb-5 fadein-bot title-section flex items-center">
          <div class="h-[1px] w-10 bg-amber-100 md:w-20 aos-init aos-animate" data-aos="zoom-in-left"
            data-aos-duration="600"></div>
          &nbsp; Skills
        </div>
      </header>
          ...
          <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400 mb-5">
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-amber-100 bg-amber-100 bg-opacity-10': activeTab === 1 }" @click="activeTab = 1">Tech Stack</button>
            </li>
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-amber-100 bg-amber-100 bg-opacity-10': activeTab === 2 }" @click="activeTab = 2">Tools</button>
            </li>
          </ul>
        </div>
        <div v-show="activeTab === 1">
          <div class="grid grid-cols-2 gap-4 pb-32 md:grid-cols-3 md:gap-8 xl:grid-cols-4 xl:gap-10 2xl:gap-12">
            <div v-for="item in tech" :key="item.id">
              <div
                class="item-tech flex cursor-pointer items-center gap-2 rounded border border-amber-100 px-2 py-2 hover:bg-amber-100 hover:bg-opacity-10 md:gap-3 lg:px-3">
                ...
                <div class="flex items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div
                    class="status-tech opacity-0 absolute mt-5 text-[10px] text-amber-100 transition-all duration-300 md:text-xs lg:text-sm">
                    {{ item.status }}</div>
                </div>
              </div>
            </div>
